...
def is_red_flag_text (text,red_flags_emotions):
    # test your text 
    ...
    for word in text.split():
        if word in red_flags_emotions.keys():
            red_flag = True 
            break
...
# test random text 
text = '' # enter target text here to check red flags  
is_red_flag_text(text,red_flags_emotions)
